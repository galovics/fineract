...
public class AdHocReadPlatformServiceImpl implements AdHocReadPlatformService {
    ...
    public Collection<AdHocData> retrieveAllActiveAdHocQuery() {
        final String sql = "select " + this.adHocRowMapper.schema() + " where r." + sqlGenerator.escape("IsActive") + " = true order by r.id";
    ...
    protected static final class AdHocMapper implements RowMapper<AdHocData> {
        ...
        public String schema() {
            return " r.id as id, r.name as name, r.query as query, r.table_name as tableName,r.table_fields as tableField ,r." + sqlGenerator.escape("IsActive") + " as isActive ,r.email as email ,"
